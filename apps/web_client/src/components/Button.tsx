...
export const Button = ({ children, variant = "primary", className = "", type = "button", ...props }: ButtonProps) => {
    ...
    const variants = {
        primary: "bg-color-content-primary text-color-bg-surface hover:opacity-85 shadow-sm hover:shadow",
        ghost: "bg-transparent text-color-content-tertiary hover:bg-color-content-primary/5 hover:text-color-content-primary",
    }
